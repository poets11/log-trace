...
public class Method<T> {
    ...
    public T invoke(Object target, Object... arguments) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        java.lang.reflect.Method method = getDeclaredMethod(target.getClass(), paramsTypeClasses);
    ...
    private java.lang.reflect.Method getDeclaredMethod(Class target, Class[] paramsTypeClasses) throws NoSuchMethodException {
        try {
            if (target == null) {
                return null;
            } else {
                return target.getDeclaredMethod(name, paramsTypeClasses);
            }
        } catch (Exception e) {
            return getDeclaredMethod(target.getSuperclass(), paramsTypeClasses);
        }
    }
