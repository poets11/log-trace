...
public class AgentConfig {
    ...
    public static final String PROP_JAVASSIST_PATH = "JAVASSIST_PATH";
    ...
    private static final String DEFAULT_CONFIG_FILE_PATH = "default_agent_config.properties";
    ...
    private static void loadConfig(Map argsMap) {
        ...
        putConfig(PROP_JAVASSIST_PATH, argsMap.get(PROP_JAVASSIST_PATH));
    ...
    public static boolean isPrintAgentLog() {
        String showAgentLog = System.getProperty("showAgentLog");
        return Boolean.parseBoolean(showAgentLog);
    }

    private static final String logPrefix = "[Trinity]";
